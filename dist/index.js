...
var ExperimentWindow = /*#__PURE__*/function (_Component) {
  _inherits(ExperimentWindow, _Component);

  var _super = _createSuper(ExperimentWindow);

  function ExperimentWindow(props) {
    var _this;

    _classCallCheck(this, ExperimentWindow);
    ...
    _this.settings = _objectSpread(_objectSpread({}, props.settings), {}, {
      timeline: props.settings.timeline || default_timeline
    });
    return _this;
  }

  _createClass(ExperimentWindow, [{
    key: "render",
    ...
    value: function componentDidMount() {
      ...
      _jspsych.default.init(_objectSpread(_objectSpread({}, this.settings), {}, {
